...
public class VideoHomeFragment extends BaseFragment<VideoHomePresenter> implements VideoHomeContract.View  {
    ...
    public void showContent(VideoListBean videoListBean) {
        ...
        adapter.setOnItemClickListener((position, view, vh, bitmap) -> {
            startChildFragment(videoListBean, position, (VideoAdapter.MyHolder) vh, bitmap);
        });
        recycler.setAdapter(adapter);
    }

    private void startChildFragment(VideoListBean videoListBean, int position, VideoAdapter.MyHolder vh, Bitmap bitmap) {
